...
alter table DLSync add description long varchar null;
...
alter table LayoutSetBranch add css long varchar null;
alter table LayoutSetBranch add settings_ long varchar null;
