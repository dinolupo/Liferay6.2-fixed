...
alter table BookmarksEntry add treePath long varchar null;
...
alter table BookmarksFolder add treePath long varchar null;
...
alter table DDMTemplate add smallImageURL long varchar;
...
alter table DLFileEntry add treePath long varchar null;
...
alter table DLFileShortcut add treePath long varchar null;
...
alter table DLFileVersion add treePath long varchar null;
alter table DLFileVersion add checksum varchar(75) null;

alter table DLFolder add treePath long varchar null;
...
alter table Group_ add treePath long varchar null;
...
alter table JournalArticle add treePath long varchar null;
