alter table Address add uuid_ nvarchar(75) null;

update BlogsEntry set status = 2 where status = 9;

alter table BookmarksEntry add treePath nvarchar(2000) null;
alter table BookmarksEntry add status int;
alter table BookmarksEntry add statusByUserId bigint;
alter table BookmarksEntry add statusByUserName nvarchar(75) null;
...
alter table BookmarksFolder add treePath nvarchar(2000) null;
alter table BookmarksFolder add status int;
alter table BookmarksFolder add statusByUserId bigint;
alter table BookmarksFolder add statusByUserName nvarchar(75) null;
...
alter table Contact_ add emailAddress nvarchar(75) null;
...
alter table DDMTemplate add smallImageURL nvarchar(2000);
...
alter table DLFileEntry add treePath nvarchar(2000) null;
...
alter table DLFileShortcut add treePath nvarchar(2000) null;
...
alter table DLFileVersion add treePath nvarchar(2000) null;
alter table DLFileVersion add checksum nvarchar(75) null;

alter table DLFolder add treePath nvarchar(2000) null;
alter table DLFolder add hidden_ bit;
alter table DLFolder add status int;
alter table DLFolder add statusByUserId bigint;
alter table DLFolder add statusByUserName nvarchar(75) null;
...
alter table EmailAddress add uuid_ nvarchar(75) null;
...
alter table Group_ add uuid_ nvarchar(75) null;
alter table Group_ add treePath nvarchar(2000) null;
...
alter table JournalArticle add treePath nvarchar(2000) null;
...
alter table Layout add userName nvarchar(75) null;
...
alter table LayoutPrototype add userName nvarchar(75) null;
...
alter table LayoutSetPrototype add userName nvarchar(75) null;

drop index Lock_.IX_228562AD;
drop index Lock_.IX_DD635956;

alter table MBBan add uuid_ nvarchar(75) null;

alter table MBCategory add status int;
alter table MBCategory add statusByUserId bigint;
alter table MBCategory add statusByUserName nvarchar(75) null;
alter table MBCategory add statusDate datetime null;

alter table MBDiscussion add uuid_ nvarchar(75) null;
...
alter table MBDiscussion add userName nvarchar(75) null;
...
alter table PasswordPolicy add uuid_ nvarchar(75) null;
alter table PasswordPolicy add regex nvarchar(75) null;
...
alter table Phone add uuid_ nvarchar(75) null;
...
alter table RepositoryEntry add userName nvarchar(75) null;
...
alter table Role_ add uuid_ nvarchar(75) null;
alter table Role_ add userId bigint;
alter table Role_ add userName nvarchar(75) null;
...
alter table UserGroup add uuid_ nvarchar(75) null;
alter table UserGroup add userId bigint;
alter table UserGroup add userName nvarchar(75) null;
...
alter table Website add uuid_ nvarchar(75) null;

alter table WikiNode add status int;
alter table WikiNode add statusByUserId bigint;
alter table WikiNode add statusByUserName nvarchar(75) null;
