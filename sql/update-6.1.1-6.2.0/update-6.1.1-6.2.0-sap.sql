...
alter table BookmarksEntry add treePath varchar null;
...
alter table BookmarksFolder add treePath varchar null;
...
alter table DDMTemplate add smallImageURL varchar;
...
alter table DLFileEntry add treePath varchar null;
...
alter table DLFileShortcut add treePath varchar null;
...
alter table DLFileVersion add treePath varchar null;
alter table DLFileVersion add checksum varchar(75) null;

alter table DLFolder add treePath varchar null;
...
update ExpandoRow set modifiedDate = timestamp;

alter table Group_ add uuid_ varchar(75) null;
alter table Group_ add treePath varchar null;
...
alter table JournalArticle add treePath varchar null;
