...
alter table BookmarksEntry add treePath varchar(750);
...
alter table BookmarksFolder add treePath varchar(750);
...
alter table DDMTemplate add smallImageURL varchar(750);
...
alter table DLFileEntry add treePath varchar(750);
...
alter table DLFileShortcut add treePath varchar(750);
...
alter table DLFileVersion add treePath varchar(750);
alter table DLFileVersion add checksum varchar(75);

alter table DLFolder add treePath varchar(750);
...
update ExpandoRow set modifiedDate = current timestamp;

alter table Group_ add uuid_ varchar(75);
alter table Group_ add treePath varchar(750);
...
alter table JournalArticle add treePath varchar(750);
