...
alter table BookmarksEntry add treePath varchar(1000) null;
alter table BookmarksEntry add status int;
alter table BookmarksEntry add statusByUserId decimal(20,0)
go
...
alter table BookmarksFolder add treePath varchar(1000) null;
alter table BookmarksFolder add status int;
alter table BookmarksFolder add statusByUserId decimal(20,0)
go
...
alter table Contact_ add classNameId decimal(20,0)
go
alter table Contact_ add classPK decimal(20,0)
go
...
alter table DDMStructure add parentStructureId decimal(20,0)
go

drop index DDMStructure.IX_490E7A1E;

alter table DDMTemplate add cacheable int;
alter table DDMTemplate add smallImage int;
alter table DDMTemplate add smallImageId decimal(20,0)
go
alter table DDMTemplate add smallImageURL varchar(1000)
go

update DDMTemplate set type_ = 'display' where type_ = 'list';
update DDMTemplate set type_ = 'form' where type_ = 'detail';

alter table DLFileEntry drop versionUserId;
alter table DLFileEntry drop versionUserName;

alter table DLFileEntry add classNameId decimal(20,0)
go
alter table DLFileEntry add classPK decimal(20,0)
go
alter table DLFileEntry add treePath varchar(1000) null;
alter table DLFileEntry add manualCheckInRequired int;
...
alter table DLFileRank add active_ int;

go

update DLFileRank set active_ = 1;

alter table DLFileShortcut add treePath varchar(1000) null;
alter table DLFileShortcut add active_ int;

go

update DLFileShortcut set active_ = 1;

alter table DLFileVersion add treePath varchar(1000) null;
alter table DLFileVersion add checksum varchar(75) null;

alter table DLFolder add treePath varchar(1000) null;
alter table DLFolder add hidden_ int;
alter table DLFolder add status int;
alter table DLFolder add statusByUserId decimal(20,0)
go
...
update ExpandoRow set modifiedDate = getdate()
go

alter table Group_ add uuid_ varchar(75) null;
alter table Group_ add treePath varchar(1000) null;
alter table Group_ add manualMembership int;
...
alter table Image drop text_;

alter table JournalArticle add folderId decimal(20,0)
go
alter table JournalArticle add treePath varchar(1000) null;
...
alter table Layout add userId decimal(20,0)
go
alter table Layout add userName varchar(75) null;

drop index Layout.IX_CED31606;
...
alter table LayoutPrototype add userId decimal(20,0)
go
...
alter table LayoutSetPrototype add userId decimal(20,0)
go
alter table LayoutSetPrototype add userName varchar(75) null;

drop index Lock_.IX_228562AD;
drop index Lock_.IX_DD635956;

alter table MBBan add uuid_ varchar(75) null;

alter table MBCategory add status int;
alter table MBCategory add statusByUserId decimal(20,0)
go
...
alter table MBDiscussion add groupId decimal(20,0)
go
alter table MBDiscussion add companyId decimal(20,0)
go
alter table MBDiscussion add userId decimal(20,0)
go
...
alter table MBMessage drop attachments;

alter table MBThread add uuid_ varchar(75) null;
alter table MBThread add userId decimal(20,0)
go
...
alter table MBThreadFlag add groupId decimal(20,0)
go
alter table MBThreadFlag add companyId decimal(20,0)
go
...
alter table Organization_ add userId decimal(20,0)
go
...
drop index PasswordPolicyRel.IX_C3A17327;
drop index PasswordPolicyRel.IX_ED7CF243;

drop table Permission_;

alter table Phone add uuid_ varchar(75) null;

alter table PollsChoice add groupId decimal(20,0)
go
alter table PollsChoice add companyId decimal(20,0)
go
alter table PollsChoice add userId decimal(20,0)
go
...
alter table PollsVote add groupId decimal(20,0)
go
...
alter table RepositoryEntry add companyId decimal(20,0)
go
alter table RepositoryEntry add userId decimal(20,0)
go
...
alter table RepositoryEntry add manualCheckInRequired int;

drop table Resource_;

drop table ResourceCode;

drop index ResourcePermission.IX_88705859;
drop index ResourcePermission.IX_C94C7708;
drop index ResourcePermission.IX_8D83D0CE;
drop index ResourcePermission.IX_4A1F4402;
drop index ResourcePermission.IX_8DB864A9;

alter table Role_ add uuid_ varchar(75) null;
alter table Role_ add userId decimal(20,0)
go
...
alter table SocialActivity add activitySetId decimal(20,0)
go
alter table SocialActivity add parentClassNameId decimal(20,0)
go
alter table SocialActivity add parentClassPK decimal(20,0)
go

alter table SocialActivityCounter add active_ int;
...
alter table User_ add ldapServerId decimal(20,0)
go
...
alter table UserGroup add userId decimal(20,0)
go
...
alter table UserNotificationEvent add delivered int;
...
alter table WikiNode add statusByUserId decimal(20,0)
go
